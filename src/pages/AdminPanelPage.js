    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-8 rounded-md shadow-md">
        ...
        {stats && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-3xl font-bold text-violet-600">{stats.activities}</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold text-gray-700 mb-2">Módulos</h3>
              <p className="text-3xl font-bold text-violet-600">{stats.modules}</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold text-gray-700 mb-2">Docentes</h3>
              <p className="text-3xl font-bold text-violet-600">{stats.teachers}</p>
            </div>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-gray-700 mb-4">Acciones Rápidas</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-gray-700 mb-4">Enlaces de Administración</h3>
            <div className="space-y-3">
              <a 
                href="/admin/actividades" 
                className="block px-4 py-2 bg-purple-100 text-violet-700 rounded-lg hover:bg-purple-200 transition-colors text-center"
              >
